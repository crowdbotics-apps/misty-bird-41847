"""
Django settings for misty_bird_41847 project.
...
ROOT_URLCONF = 'misty_bird_41847.urls'
...
WSGI_APPLICATION = 'misty_bird_41847.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_bird_41847 API",
    "DESCRIPTION": "API documentation for misty_bird_41847 App",
    "VERSION": "v1",
}
